...
namespace SampleProject.Presentation.LaunchSitecore.Configuration.Helpers
{
  public class ItemNamingHelper
  {
    ...
    {
     return Sitecore.Configuration.Settings.GetBoolSetting("SampleProject.Presentation.LaunchSitecoreItemNaming.ReplaceSpacesWithDashesInItemNames", true);
    }

    public static bool StorePrettyNameInDisplayName()
    {
     return Sitecore.Configuration.Settings.GetBoolSetting("SampleProject.Presentation.LaunchSitecoreItemNaming.StorePrettyNameInDisplayName", true);
    }
    ...
    {
     return Sitecore.Configuration.Settings.GetBoolSetting("SampleProject.Presentation.LaunchSitecoreItemNaming.ShowContentEditorWarnings", false);
    }
