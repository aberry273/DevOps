...
namespace SampleProject.Presentation.LaunchSitecore.Models
{
  ...
  public class MenuItemList : IRenderingModel
  {
    ...
    public void LoadMenuItems()
    {
      ...
      Item homeItem = SampleProject.Presentation.LaunchSitecore.Configuration.SiteConfiguration.GetHomeItem();
      if (homeItem != null)
      {
